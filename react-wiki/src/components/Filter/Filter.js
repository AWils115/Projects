...
const Filter = ({ pageNumber, updatePageNumber, updateStatus, updateGender, updateSpecies }) => {
	/**
	 * * This function allows the user to filter the characters bases on status, gender
	 * * and species.
	 * * Each category will have its own component.
	 * * The clear fucntion clears the filters.
	 */
